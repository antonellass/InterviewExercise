...
public class TaxCalculatorTest extends TestCase {
	...
	/**
	 * Verifies if output file Output1.txt generated from Input1.txt is equal to expected File
	 * @throws IOException
	 */
	@Test
	...
	/**
	 * Verifies if output file Output2.txt generated from Input2.txt is equal to expected File
	 * @throws IOException
	 */
	@Test
	...
	/**
	 * Verifies if output file Output3.txt generated from Input3.txt is equal to expected File
	 * @throws IOException
	 */
	@Test
